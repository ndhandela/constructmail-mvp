    ...
    <div className="privacy-container">
      ...
      <section className="privacy-body">
        <div className="privacy-content">
          ...
          <section>
            <h2>5. Gmail Data</h2>
            <p>POMAR Mail uses the Gmail API in read-only mode. We only access emails you explicitly select for analysis. We do not store email content after analysis is complete.</p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>TechDen Solutions</strong><br />
              Prosper, TX<br />
